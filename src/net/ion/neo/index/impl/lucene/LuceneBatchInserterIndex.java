...
import static net.ion.neo.index.impl.lucene.LuceneDataSource.LUCENE_VERSION;
import static net.ion.neo.index.impl.lucene.LuceneDataSource.getDirectory;
...
class LuceneBatchInserterIndex implements BatchInserterIndex, org.neo4j.unsafe.batchinsert.BatchInserterIndex {
	...
	/**
	 * Sets the number of modifications that will be the threshold for a commit to happen. This will free up memory.
	 * 
	 * @param size
	 *            the threshold for triggering a commit.
	 */
