...
class IndexReference {
	...
	/**
	 * We need this because we only want to close the reader/searcher if it has been detached... i.e. the {@link LuceneDataSource} no longer has any reference to it, only an iterator out in the client has a ref. And when that client calls close() it should be closed.
	 */
