 ...
 * <p>
 * <b>Caution:</b> Iterate only over the hits needed. Iterating over all hits is generally not desirable and may be the source of performance issues.
 * </p>
 * <p>
 * <b>Note:</b> Deleting matching documents concurrently with traversing the hits, might, when deleting hits that were not yet retrieved, decrease {@link #length()}. In such case, {@link java.util.ConcurrentModificationException ConcurrentModificationException} is thrown when accessing hit <code>n</code> &ge; current_{@link #length()} (but <code>n</code> &lt; {@link #length()}_at_start).
 * 
 * see {@link org.apache.lucene.search.Searcher#search(org.apache.lucene.search.Query , int)}, {@link org.apache.lucene.search.Searcher#search(org.apache.lucene.search.Query , org.apache.lucene.search.Filter , int)} and {@link org.apache.lucene.search.Searcher#search(org.apache.lucene.search.Query , org.apache.lucene.search.Filter , int, org.apache.lucene.search.Sort)}:<br>
 * 
 * <pre>
...
public final class Hits {
	...
	/**
	 * Tries to add new documents to hitDocs. Ensures that the hit numbered <code>min</code> has been retrieved.
	 */
	...
	/**
	 * Returns a {@link HitIterator} to navigate the Hits. Each item returned from {@link java.util.Iterator#next()} is a {@link Hit}.
	 * <p>
	 * <b>Caution:</b> Iterate only over the hits needed. Iterating over all hits is generally not desirable and may be the source of performance issues. If you need to iterate over many or all hits, consider using a search method that takes a {@link HitCollector}.
	 * </p>
	 */
...
final class HitDoc {
	...
	net.ion.neo.index.impl.lucene.HitDoc next; // in doubly-linked cache
	net.ion.neo.index.impl.lucene.HitDoc prev; // in doubly-linked cache
